...
@Component({
  selector: 'app-destination-rio',
  templateUrl: './destination-rio.component.html',
  styleUrls: ['./destination-rio.component.css']
})
export class DestinationRioComponent implements OnInit {
  userObject: object;
  ...
  jQuery(document).ready(()=>{
    jQuery("#overview").click(()=>{
        jQuery("#overviewText").slideToggle("slow")
      });
    
    jQuery("#attraction").click(()=>{
      jQuery("#attractionText").slideToggle("slow")
    });

    jQuery("#tg").click(()=>{
      jQuery("#tgText").slideToggle("slow")
    });

    jQuery("#budget").click(()=>{
      jQuery("#budgetText").slideToggle("slow")
    });

    jQuery("#ticket").click(()=>{
      jQuery("#ticketText").slideToggle("slow")
    });
    });
